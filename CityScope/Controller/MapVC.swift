...
class MapVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    func animateViewUp() {
        ...
        buttonBottomSpace.constant = -320
...
extension MapVC: MKMapViewDelegate {
    ...
    func retrieveUrls(forAnnotation annotation: DropablePin, handler: @escaping (_ status: Bool) -> ()) {
        ...
        Alamofire.request(flicrkURL(forApiKey: apiKey, withAnnotation: annotation, andNumberOfPhotos: 40)).responseJSON { (response) in
